...
\title{{\Huge Bootstrap \commonlisp{}}\\
  A \commonlisp{} implementation intended solely\\
  for bootstrapping other \commonlisp{} implementations.}
